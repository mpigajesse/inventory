  ...
  return (
    <li>
      <Link
        ...
        className={cn(
          "group relative flex items-center gap-3 h-11 text-[13px] font-medium",
          "transition-all duration-150 ease-out",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20",
          !isActive && "hover:bg-[hsl(0_0%_100%/0.07)] active:bg-[hsl(0_0%_100%/0.07)]",
        ...
        >
          ...
          >
            ...
            <button
              ...
              className={cn(
                "shrink-0 flex items-center justify-center min-h-[44px] min-w-[44px] rounded-md transition-colors",
          ...
          {collapsed && (
            <button
              ...
              title="Déconnexion"
              aria-label="Déconnexion"
              className="hidden md:flex items-center justify-center w-full min-h-[44px] mt-1 rounded-md transition-colors hover:bg-[hsl(var(--destructive)/0.15)] hover:text-[hsl(var(--destructive))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20"
              style={{ color: "hsl(var(--sidebar-fg))" }}
            >
              <LogOut className="w-[16px] h-[16px]" />
            </button>
