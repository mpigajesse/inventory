    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-11 w-11 sm:h-7 sm:w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-10 sm:w-9 font-normal text-[0.8rem]",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-10 w-10 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100"),
